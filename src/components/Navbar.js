    ...
    <div>
      ...
      >
        ...
        {isPopupVisible && (
          <div
            ref={popupRef}
            className="absolute bg-fuchsia-300 border-blue-950 rounded-lg shadow-lg mt-2 w-56"
            style={{
              left: "1rem",
              top: "3rem",
              zIndex: 1000,
          ...
          >
            <ul className="py-2">
              <li className="px-4 py-2 hover:bg-slate-400 text-amber-800">
                <Link to="/">Home</Link>
              </li>
              <li className="px-4 py-2 hover:bg-slate-400 text-amber-800">
        ...
        >
          <select className="h-8 px-16 mx-80 bg-gray-200 border border-blue-800 rounded-md text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        ...
        <form className="w-[500px] mx-auto mr-72 ">
          ...
          <div className="relative">
            ...
            <input
              type="search"
              id="default-search"
              className="block w-full h-10 border-blue-950  -my-10 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
